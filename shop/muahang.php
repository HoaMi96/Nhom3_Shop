...
<div style="width: 1000px; margin: 0 auto;">
	...
	<form action="muahang.php" method="post">
	                <table width="100%" border=0 cellpadding=0 cellspacing=0><tr style="background:pink;font-family:sans-serif;font-weight:bolder;font-size:14px;height:35px;color:#061092;">
                <td align="center">STT</td><td>Tên sản phẩm</td><td>Giá</td><td>Số lượng </td><td>DVT</td><td align="center">Thành tiền</td>
                </tr>
               <?php
			   require("doctien.php");
  ...
  <table width="516" border="0" cellspacing="1" cellpadding="5" align="center">
    ...
    <tr>
      <td colspan="2" bgcolor="#99FFFF"><div align="left">
        ...
        <p class="style5"> <span class="style1"><em  style="font-weight: bold";>Lưu ý:</em></span>  Thời gian giao hàng là 2 ngày kể từ ngày giao dịch. </p>
      </div></td>
    </tr>
    <tr>
