...
require("connect.php");
    ...
    // $ro=mysqli_fetch_assoc($connect,$sql);
    // if($ro['kk']==0)
    // {
    ...
    <body style="background-image: url(images/background-index.png);background-repeat: repeat-x;background-attachment: fixed;margin: 0;" onload="Clock2();setvt();">
        <div>
                ...
                <table width="100%" cellpadding=0 cellspacing=0>
                    <tr>
                        <td style="width:200px;" valign="top">
                            <div>
                                <table border=1 cellspacing=2 cellpadding=4 width="100%">
                                    <tr style="background:#0059c8;color:#ffffff;"><td style="font-family:sans-serif;font-weight:bold;">Hàng hóa hiện có</td></tr>
                                    <?php
                                        ...
                                        {
                                            $i=$i+1;
                                            echo"<tr style='background:#9ebed2;' id='tr".$i."' onmouseover=\"mover('tr".$i."')\" onmouseout=\"mout('tr".$i."')\"><td style='font-family:arial;font-size:12px;'><a href='index.php?id_loai=".$row['ma_loai']."' style='color:blue;display:block;padding-left:10px;text-decoration:none;font-weight:bold'>".ucwords($row['ten_loai'])."</a></td></tr>";
                                        }
                                    ?>
                                </table>
                            </div>
                            <div style="margin-top:10px;">
                                    <table border=1 cellspacing=2 cellpadding=4 width="100%">
                                        <tr style="background:pink;color:black;"><td style="font-family:sans-serif;font-weight:bold;">Search</td></tr>
                                        <tr style="background:#9ebed2;"><td><div><table border=0 cellpadding=0 cellspacing=0><tr><td width=30><img src="images/search.png" height=25></td><td style="font-weight:bold">Tìm theo giá</td></tr></table></div></td></tr>
                                        <tr>
                                            <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select name="gia2" style="width:150px;">
                                                                        ...
                                                                        <option value="larger">> 100.000.000</option>
                                                                    </select>
                                                                </td>
                                                                </tr>
                                                        </table>
                                        ...
                                        <tr style="background:pink;"><td><div><table border=0 cellpadding=0 cellspacing=0><tr><td width=30><img src="images/search.png" height=25></td><td style="font-weight:bold;">Tìm theo tên sản phẩm </td></tr></table></div></td></tr>
                                        <tr><td>
                        ...
                        <td valign="top">
                            <div>
                                <table border=1 cellspacing=2 cellpadding=4 width="100%">
                                    <tr style="background:#0059c8;color:#ffffff;"><td style="font-family:sans-serif;font-weight:bold;" colspan="5">Sản phẩm 
                                    <?php
                                    ...
                                    <?php
                                        ...
                                        if(isset($ma_loai))
                                        {
                                            ...
                                            while($row=mysql_fetch_assoc($sql))
                                            {
                                                ...
                                                $sql2=mysqli_query($connect,$str2);
                                                $j=0;
            ...
            <div class="footer-index">
                ...
                <table width="100%"><tr><td align="center" style="color:#ffffff;"><b>Công Ty Bách hóa xanh</b><br>Địa Chỉ : 123, Đường Nguyễn văn Cừ, Q.5, TP.Hồ Chí Minh.<br>Điện Thọai : 0926378436.<br>Fax : 07674832428.</td></tr></table>
            </div>
        </div>
    </body>
</html>
